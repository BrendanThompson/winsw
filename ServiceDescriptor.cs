    ...
    public class ServiceDescriptor
    {
        ...
        public ServiceDescriptor()
        {
            ...
            while (true)
            {
                ...
                if (d.Parent == null)
                    throw new FileNotFoundException("Unable to locate " + baseName +
                                                    ".xml file within executable directory or any parents");
        ...
        {
            get { return SingleElement("executable"); }
        }
        ...
        {
            get { return SingleElement("stopexecutable"); }
        }
        ...
        {
            get { return AppendTags("stopargument"); }
        }
                    ...
                    case "roll-by-time":
                        ...
                        if (patternNode == null)
                        {
                            throw new InvalidDataException(
                                "Time Based rolling policy is specified but no pattern can be found in configuration XML.");
                        }
                        var pattern = patternNode.InnerText;
                        var period = SingleIntElement(e, "period", 1);
                        return new TimeBasedRollingLogAppender(LogDirectory, BaseName, pattern, period);

                    case "roll-by-size":
                        var sizeThreshold = SingleIntElement(e, "sizeThreshold", 10*1024)*
                                            SizeBasedRollingLogAppender.BYTES_PER_KB;
                        var keepFiles = SingleIntElement(e, "keepFiles",
        ...
        public string[] ServiceDependencies
        {
            get
            {
                var serviceDependencies = new ArrayList();
        ...
        public string Id
        {
            get { return SingleElement("id"); }
        }

        public string Caption
        {
            get { return SingleElement("name"); }
        }

        public string Description
        {
            get { return SingleElement("description"); }
        }
        ...
        public StartMode StartMode
        {
            get
            {
                ...
                catch
                {
                    ...
                    foreach (var sm in Enum.GetNames(typeof (StartMode)))
                    {
        ...
        {
            get { return dom.SelectSingleNode("//beeponshutdown") != null; }
        }

        /// <summary>
        ///     The estimated time required for a pending stop operation (default 15 secs).
        ///     Before the specified amount of time has elapsed, the service should make its next call to the SetServiceStatus
        ///     function
        ///     with either an incremented checkPoint value or a change in currentState. (see
        ///     http://msdn.microsoft.com/en-us/library/ms685996.aspx)
        /// </summary>
        public TimeSpan WaitHint
        {
            get { return SingleTimeSpanElement(dom.FirstChild, "waithint", TimeSpan.FromSeconds(15)); }
        }
        ...
        ///     Do not wait longer than the wait hint. A good interval is one-tenth of the wait hint but not less than 1 second and
        ///     not more than 10 seconds.
        /// </summary>
        public TimeSpan SleepTime
        {
            get { return SingleTimeSpanElement(dom.FirstChild, "sleeptime", TimeSpan.FromSeconds(1)); }
        }
        ...
        {
            get { return dom.SelectSingleNode("//interactive") != null; }
        }
        ...
        public List<SC_ACTION> FailureActions
        {
            get
            {
                ...
                if (childNodes != null)
                {
                    ...
                    {
                        SC_ACTION_TYPE type;
                        var action = n.Attributes["action"].Value;
                        switch (action)
                        {
                            case "restart":
        ...
        {
            get { return SingleTimeSpanElement(dom.FirstChild, "resetfailure", TimeSpan.FromDays(1)); }
        }

        protected string AllowServiceLogon
        {
            get { return GetServiceAccountPart("allowservicelogon"); }
        }

        // ReSharper disable once InconsistentNaming
        protected string serviceAccountDomain
        {
            get { return GetServiceAccountPart("domain"); }
        }

        // ReSharper disable once InconsistentNaming
        protected string serviceAccountName
        {
            get { return GetServiceAccountPart("user"); }
        }

        public string ServiceAccountPassword
        {
            get { return GetServiceAccountPart("password"); }
        }
        ...
        public bool AllowServiceAcountLogonRight
        {
            get
            {
                ...
                {
                    bool parsedvalue;
                    if (bool.TryParse(AllowServiceLogon, out parsedvalue))
                    {
                        return parsedvalue;
                    }
                }
        ...
        {
            get { return SingleTimeSpanElement(dom.FirstChild, "stoptimeout", TimeSpan.FromSeconds(15)); }
        }
